...
export function Leaderboard() {
  ...
  // Fetch leaderboard from Convex via the React client
  ...
  const entries = tab === 'overall' ? (overallData ?? []) : (gameData ?? []);

  // Backend already sorts by totalStars desc, but ensure it here too
  const sorted = [...entries].sort((a: any, b: any) => b.totalStars - a.totalStars);
