...
const ALL_TEXTURES: Record<number, Texture[]> = {
  ...
  11: [
    { name: 'Lava Blob', emoji: '🌋', color: '#dc2626', bg: '#fecaca', feel: 'warm and gloopy' },
    { name: 'Time Slime', emoji: '⏰', color: '#0891b2', bg: '#cffafe', feel: 'changes as you touch' },
    { name: 'Crystal Crunch', emoji: '💎', color: '#22d3ee', bg: '#cffafe', feel: 'crunchy and sharp' },
    { name: 'Velvet Moss', emoji: '🌿', color: '#16a34a', bg: '#dcfce7', feel: 'soft and damp' },
    { name: 'Thunder Putty', emoji: '⚡', color: '#eab308', bg: '#fef9c3', feel: 'vibrating and warm' },
    { name: 'Ghost Slime', emoji: '👻', color: '#a78bfa', bg: '#ede9fe', feel: 'cold and slippery' },
  ],
  12: [
    { name: 'Crystal Crunch', emoji: '💎', color: '#22d3ee', bg: '#cffafe', feel: 'crunchy and sharp' },
    { name: 'Velvet Moss', emoji: '🌿', color: '#16a34a', bg: '#dcfce7', feel: 'soft and damp' },
    { name: 'Thunder Putty', emoji: '⚡', color: '#eab308', bg: '#fef9c3', feel: 'vibrating and warm' },
    { name: 'Ghost Slime', emoji: '👻', color: '#a78bfa', bg: '#ede9fe', feel: 'cold and slippery' },
    { name: 'Cloud Cotton', emoji: '☁️', color: '#94a3b8', bg: '#f1f5f9', feel: 'fluffy and dry' },
    { name: 'Honeycomb Wax', emoji: '🍯', color: '#f59e0b', bg: '#fef3c7', feel: 'waxy and sticky' },
    { name: 'Frost Gel', emoji: '❄️', color: '#38bdf8', bg: '#e0f2fe', feel: 'icy and smooth' },
  ],
  13: [
    { name: 'Cloud Cotton', emoji: '☁️', color: '#94a3b8', bg: '#f1f5f9', feel: 'fluffy and dry' },
    { name: 'Honeycomb Wax', emoji: '🍯', color: '#f59e0b', bg: '#fef3c7', feel: 'waxy and sticky' },
    { name: 'Frost Gel', emoji: '❄️', color: '#38bdf8', bg: '#e0f2fe', feel: 'icy and smooth' },
    { name: 'Magma Sludge', emoji: '🔥', color: '#ea580c', bg: '#ffedd5', feel: 'hot and thick' },
    { name: 'Petal Silk', emoji: '🌸', color: '#f9a8d4', bg: '#fce7f3', feel: 'silky and delicate' },
    { name: 'Bark Rough', emoji: '🌳', color: '#78350f', bg: '#fef3c7', feel: 'rough and scratchy' },
    { name: 'Bubble Foam', emoji: '🫧', color: '#67e8f9', bg: '#cffafe', feel: 'light and popping' },
  ],
  14: [
    { name: 'Magma Sludge', emoji: '🔥', color: '#ea580c', bg: '#ffedd5', feel: 'hot and thick' },
    { name: 'Petal Silk', emoji: '🌸', color: '#f9a8d4', bg: '#fce7f3', feel: 'silky and delicate' },
    { name: 'Bark Rough', emoji: '🌳', color: '#78350f', bg: '#fef3c7', feel: 'rough and scratchy' },
    { name: 'Bubble Foam', emoji: '🫧', color: '#67e8f9', bg: '#cffafe', feel: 'light and popping' },
    { name: 'Star Dust', emoji: '✨', color: '#fbbf24', bg: '#fef9c3', feel: 'gritty and shimmering' },
    { name: 'Moon Sand', emoji: '🌙', color: '#cbd5e1', bg: '#f1f5f9', feel: 'moldable and soft' },
    { name: 'Rain Drop', emoji: '💧', color: '#3b82f6', bg: '#dbeafe', feel: 'wet and cool' },
    { name: 'Wind Wisps', emoji: '🌬️', color: '#a5f3fc', bg: '#ecfeff', feel: 'barely there' },
  ],
  15: [
    { name: 'Star Dust', emoji: '✨', color: '#fbbf24', bg: '#fef9c3', feel: 'gritty and shimmering' },
    { name: 'Moon Sand', emoji: '🌙', color: '#cbd5e1', bg: '#f1f5f9', feel: 'moldable and soft' },
    { name: 'Rain Drop', emoji: '💧', color: '#3b82f6', bg: '#dbeafe', feel: 'wet and cool' },
    { name: 'Wind Wisps', emoji: '🌬️', color: '#a5f3fc', bg: '#ecfeff', feel: 'barely there' },
    { name: 'Shadow Goo', emoji: '🌑', color: '#475569', bg: '#f1f5f9', feel: 'dark and heavy' },
    { name: 'Sunbeam Gel', emoji: '☀️', color: '#fde047', bg: '#fefce8', feel: 'warm and light' },
    { name: 'Coral Sponge', emoji: '🪸', color: '#f43f5e', bg: '#ffe4e6', feel: 'porous and squishy' },
    { name: 'Pearl Paste', emoji: '🦪', color: '#e2e8f0', bg: '#f8fafc', feel: 'smooth and cool' },
  ],
  16: [
    { name: 'Shadow Goo', emoji: '🌑', color: '#475569', bg: '#f1f5f9', feel: 'dark and heavy' },
    { name: 'Sunbeam Gel', emoji: '☀️', color: '#fde047', bg: '#fefce8', feel: 'warm and light' },
    { name: 'Coral Sponge', emoji: '🪸', color: '#f43f5e', bg: '#ffe4e6', feel: 'porous and squishy' },
    { name: 'Pearl Paste', emoji: '🦪', color: '#e2e8f0', bg: '#f8fafc', feel: 'smooth and cool' },
    { name: 'Amber Resin', emoji: '🟠', color: '#d97706', bg: '#fef3c7', feel: 'hard but warm' },
    { name: 'Jade Clay', emoji: '🟢', color: '#059669', bg: '#d1fae5', feel: 'dense and cool' },
    { name: 'Opal Mist', emoji: '💫', color: '#c084fc', bg: '#f3e8ff', feel: 'shifting and light' },
    { name: 'Ruby Dust', emoji: '🔴', color: '#ef4444', bg: '#fee2e2', feel: 'fine and warm' },
    { name: 'Sapphire Slime', emoji: '🔵', color: '#2563eb', bg: '#dbeafe', feel: 'cold and slick' },
  ],
  17: [
    { name: 'Amber Resin', emoji: '🟠', color: '#d97706', bg: '#fef3c7', feel: 'hard but warm' },
    { name: 'Jade Clay', emoji: '🟢', color: '#059669', bg: '#d1fae5', feel: 'dense and cool' },
    ...
    { name: 'Ruby Dust', emoji: '🔴', color: '#ef4444', bg: '#fee2e2', feel: 'fine and warm' },
    { name: 'Sapphire Slime', emoji: '🔵', color: '#2563eb', bg: '#dbeafe', feel: 'cold and slick' },
    { name: 'Emerald Moss', emoji: '💚', color: '#10b981', bg: '#d1fae5', feel: 'velvety and damp' },
    { name: 'Topaz Honey', emoji: '🟡', color: '#f59e0b', bg: '#fef3c7', feel: 'thick and sweet' },
    { name: 'Onyx Mud', emoji: '⚫', color: '#1e293b', bg: '#f1f5f9', feel: 'heavy and smooth' },
    { name: 'Quartz Crystal', emoji: '💎', color: '#e0e7ff', bg: '#eef2ff', feel: 'hard and cold' },
  ],
  18: [
    { name: 'Emerald Moss', emoji: '💚', color: '#10b981', bg: '#d1fae5', feel: 'velvety and damp' },
    { name: 'Topaz Honey', emoji: '🟡', color: '#f59e0b', bg: '#fef3c7', feel: 'thick and sweet' },
    { name: 'Onyx Mud', emoji: '⚫', color: '#1e293b', bg: '#f1f5f9', feel: 'heavy and smooth' },
    { name: 'Quartz Crystal', emoji: '💎', color: '#e0e7ff', bg: '#eef2ff', feel: 'hard and cold' },
    { name: 'Diamond Dust', emoji: '💠', color: '#93c5fd', bg: '#eff6ff', feel: 'sharp and glittering' },
    { name: 'Platinum Putty', emoji: '⚙️', color: '#94a3b8', bg: '#f1f5f9', feel: 'metallic and firm' },
    { name: 'Mercury Drop', emoji: '🌡️', color: '#64748b', bg: '#f8fafc', feel: 'liquid and heavy' },
    { name: 'Nebula Foam', emoji: '🌌', color: '#8b5cf6', bg: '#ede9fe', feel: 'cosmic and airy' },
    { name: 'Void Gel', emoji: '🕳️', color: '#0f172a', bg: '#1e293b', feel: 'nothing and everything' },
  ],
  19: [
    { name: 'Diamond Dust', emoji: '💠', color: '#93c5fd', bg: '#eff6ff', feel: 'sharp and glittering' },
    { name: 'Platinum Putty', emoji: '⚙️', color: '#94a3b8', bg: '#f1f5f9', feel: 'metallic and firm' },
    ...
    { name: 'Nebula Foam', emoji: '🌌', color: '#8b5cf6', bg: '#ede9fe', feel: 'cosmic and airy' },
    { name: 'Void Gel', emoji: '🕳️', color: '#0f172a', bg: '#1e293b', feel: 'nothing and everything' },
    { name: 'Phoenix Ash', emoji: '🔥', color: '#f97316', bg: '#fff7ed', feel: 'warm and powdery' },
    { name: 'Dragon Scale', emoji: '🐉', color: '#059669', bg: '#d1fae5', feel: 'smooth but hard' },
    { name: 'Unicorn Mane', emoji: '🦄', color: '#f472b6', bg: '#fce7f3', feel: 'silky and magical' },
    { name: 'Fairy Dust', emoji: '🧚', color: '#fbbf24', bg: '#fef9c3', feel: 'sparkly and light' },
    { name: 'Witch Brew', emoji: '🧙', color: '#7c3aed', bg: '#ede9fe', feel: 'bubbly and strange' },
  ],
  20: [
    { name: 'Phoenix Ash', emoji: '🔥', color: '#f97316', bg: '#fff7ed', feel: 'warm and powdery' },
    { name: 'Dragon Scale', emoji: '🐉', color: '#059669', bg: '#d1fae5', feel: 'smooth but hard' },
    ...
    { name: 'Fairy Dust', emoji: '🧚', color: '#fbbf24', bg: '#fef9c3', feel: 'sparkly and light' },
    { name: 'Witch Brew', emoji: '🧙', color: '#7c3aed', bg: '#ede9fe', feel: 'bubbly and strange' },
    { name: 'Cosmic Slime', emoji: '🪐', color: '#6366f1', bg: '#e0e7ff', feel: 'infinite and stretchy' },
    { name: 'Quantum Goo', emoji: '⚛️', color: '#06b6d4', bg: '#cffafe', feel: 'everywhere at once' },
    { name: 'Dimension Putty', emoji: '🌀', color: '#a855f7', bg: '#f3e8ff', feel: 'shifts between states' },
    { name: 'Infinity Gel', emoji: '♾️', color: '#ec4899', bg: '#fce7f3', feel: 'never-ending texture' },
    { name: 'Ultimate Squish', emoji: '🧪', color: '#14b8a6', bg: '#ccfbf1', feel: 'EVERYTHING at once!' },
  ],
};
