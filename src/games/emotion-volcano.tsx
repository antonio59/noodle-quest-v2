...
const allScenarios: Record<number, { trigger: string; emoji: string; heat: number }[]> = {
  ...
  11: [
    ...
    { trigger: 'You feel like giving up on everything', emoji: '😢', heat: 75 },
    { trigger: 'Multiple bad things happened at once', emoji: '⛈️', heat: 80 },
    { trigger: 'You were excluded from something important', emoji: '🚪', heat: 78 },
  ],
  12: [
    { trigger: 'Everything feels unfair and overwhelming', emoji: '😤', heat: 85 },
    { trigger: "You feel really angry but don't know why", emoji: '🌋', heat: 80 },
    ...
    { trigger: 'Multiple bad things happened at once', emoji: '⛈️', heat: 80 },
    { trigger: 'You were excluded from something important', emoji: '🚪', heat: 78 },
    { trigger: "Someone took credit for your hard work", emoji: '📋', heat: 82 },
  ],
  13: [
    { trigger: 'Everything feels unfair and overwhelming', emoji: '😤', heat: 85 },
    { trigger: "You feel really angry but don't know why", emoji: '🌋', heat: 80 },
    ...
    { trigger: 'You were excluded from something important', emoji: '🚪', heat: 78 },
    { trigger: "Someone took credit for your hard work", emoji: '📋', heat: 82 },
    { trigger: 'You feel misunderstood by everyone', emoji: '🤷', heat: 77 },
  ],
  14: [
    { trigger: 'Everything feels unfair and overwhelming', emoji: '😤', heat: 85 },
    { trigger: "You feel really angry but don't know why", emoji: '🌋', heat: 80 },
    ...
    { trigger: "Someone took credit for your hard work", emoji: '📋', heat: 82 },
    { trigger: 'You feel misunderstood by everyone', emoji: '🤷', heat: 77 },
    { trigger: 'Your biggest fear just came true', emoji: '😱', heat: 90 },
  ],
  15: [
    { trigger: 'Everything feels unfair and overwhelming', emoji: '😤', heat: 85 },
    { trigger: "You feel really angry but don't know why", emoji: '🌋', heat: 80 },
    ...
    { trigger: 'You feel misunderstood by everyone', emoji: '🤷', heat: 77 },
    { trigger: 'Your biggest fear just came true', emoji: '😱', heat: 90 },
    { trigger: "You're being teased for something you can't change", emoji: '😞', heat: 88 },
  ],
  16: [
    { trigger: 'Everything feels unfair and overwhelming', emoji: '😤', heat: 85 },
    { trigger: "You feel really angry but don't know why", emoji: '🌋', heat: 80 },
    ...
    { trigger: 'Your biggest fear just came true', emoji: '😱', heat: 90 },
    { trigger: "You're being teased for something you can't change", emoji: '😞', heat: 88 },
    { trigger: 'A friend betrayed your trust completely', emoji: '🗡️', heat: 92 },
  ],
  17: [
    { trigger: 'Everything feels unfair and overwhelming', emoji: '😤', heat: 85 },
    { trigger: "You feel really angry but don't know why", emoji: '🌋', heat: 80 },
    ...
    { trigger: "You're being teased for something you can't change", emoji: '😞', heat: 88 },
    { trigger: 'A friend betrayed your trust completely', emoji: '🗡️', heat: 92 },
    { trigger: "You're being blamed for something serious", emoji: '⚖️', heat: 87 },
  ],
  18: [
    { trigger: 'Everything feels unfair and overwhelming', emoji: '😤', heat: 85 },
    { trigger: "You feel really angry but don't know why", emoji: '🌋', heat: 80 },
    ...
    { trigger: 'A friend betrayed your trust completely', emoji: '🗡️', heat: 92 },
    { trigger: "You're being blamed for something serious", emoji: '⚖️', heat: 87 },
    { trigger: 'You feel completely alone in the world', emoji: '🌍', heat: 90 },
  ],
  19: [
    { trigger: 'Everything feels unfair and overwhelming', emoji: '😤', heat: 85 },
    { trigger: "You feel really angry but don't know why", emoji: '🌋', heat: 80 },
    ...
    { trigger: "You're being blamed for something serious", emoji: '⚖️', heat: 87 },
    { trigger: 'You feel completely alone in the world', emoji: '🌍', heat: 90 },
    { trigger: 'Something you love was destroyed', emoji: '💥', heat: 93 },
  ],
  20: [
    { trigger: 'Everything feels unfair and overwhelming', emoji: '😤', heat: 85 },
    { trigger: "You feel really angry but don't know why", emoji: '🌋', heat: 80 },
    ...
    { trigger: 'You feel completely alone in the world', emoji: '🌍', heat: 90 },
    { trigger: 'Something you love was destroyed', emoji: '💥', heat: 93 },
    { trigger: 'You feel like nothing you do matters', emoji: '🫠', heat: 95 },
  ],
};
