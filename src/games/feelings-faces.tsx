...
const allQuestions: Record<number, Question[]> = {
  ...
  11: [
    { scenario: 'Everyone is depending on you to win', emoji: '🏅', correct: 'pressured', options: ['calm', 'pressured', 'bored', 'relaxed'] },
    { scenario: 'You made someone smile when they were sad', emoji: '😊', correct: 'fulfilled', options: ['guilty', 'fulfilled', 'jealous', 'angry'] },
    { scenario: "You realized you forgot a friend's birthday", emoji: '📅', correct: 'remorseful', options: ['happy', 'remorseful', 'proud', 'excited'] },
    { scenario: 'Your secret talent got discovered', emoji: '🌟', correct: 'exposed', options: ['exposed', 'angry', 'bored', 'proud'] },
    { scenario: 'You finished everything and have free time', emoji: '⏰', correct: 'content', options: ['stressed', 'content', 'guilty', 'nervous'] },
    { scenario: 'Two friends are fighting and want you to pick sides', emoji: '😰', correct: 'torn', options: ['excited', 'torn', 'proud', 'happy'] },
    { scenario: 'You see a stray animal alone in the rain', emoji: '🐱', correct: 'compassionate', options: ['compassionate', 'indifferent', 'amused', 'bored'] },
  ],
  12: [
    { scenario: 'Everyone is depending on you to win', emoji: '🏅', correct: 'pressured', options: ['calm', 'pressured', 'bored', 'relaxed'] },
    { scenario: 'You made someone smile when they were sad', emoji: '😊', correct: 'fulfilled', options: ['guilty', 'fulfilled', 'jealous', 'angry'] },
    ...
    { scenario: 'Two friends are fighting and want you to pick sides', emoji: '😰', correct: 'torn', options: ['excited', 'torn', 'proud', 'happy'] },
    { scenario: 'You see a stray animal alone in the rain', emoji: '🐱', correct: 'compassionate', options: ['compassionate', 'indifferent', 'amused', 'bored'] },
    { scenario: 'Someone apologizes sincerely for hurting you', emoji: '🤝', correct: 'forgiving', options: ['forgiving', 'vengeful', 'indifferent', 'bored'] },
  ],
  13: [
    { scenario: 'Everyone is depending on you to win', emoji: '🏅', correct: 'pressured', options: ['calm', 'pressured', 'bored', 'relaxed'] },
    { scenario: 'You made someone smile when they were sad', emoji: '😊', correct: 'fulfilled', options: ['guilty', 'fulfilled', 'jealous', 'angry'] },
    ...
    { scenario: 'You see a stray animal alone in the rain', emoji: '🐱', correct: 'compassionate', options: ['compassionate', 'indifferent', 'amused', 'bored'] },
    { scenario: 'Someone apologizes sincerely for hurting you', emoji: '🤝', correct: 'forgiving', options: ['forgiving', 'vengeful', 'indifferent', 'bored'] },
    { scenario: 'You realize you were wrong about someone', emoji: '🤔', correct: 'humbled', options: ['humbled', 'arrogant', 'bored', 'excited'] },
  ],
  14: [
    { scenario: 'Everyone is depending on you to win', emoji: '🏅', correct: 'pressured', options: ['calm', 'pressured', 'bored', 'relaxed'] },
    { scenario: 'You made someone smile when they were sad', emoji: '😊', correct: 'fulfilled', options: ['guilty', 'fulfilled', 'jealous', 'angry'] },
    ...
    { scenario: 'Someone apologizes sincerely for hurting you', emoji: '🤝', correct: 'forgiving', options: ['forgiving', 'vengeful', 'indifferent', 'bored'] },
    { scenario: 'You realize you were wrong about someone', emoji: '🤔', correct: 'humbled', options: ['humbled', 'arrogant', 'bored', 'excited'] },
    { scenario: 'You watch the sunset after a really hard day', emoji: '🌅', correct: 'peaceful', options: ['peaceful', 'frustrated', 'anxious', 'angry'] },
  ],
  15: [
    { scenario: 'Everyone is depending on you to win', emoji: '🏅', correct: 'pressured', options: ['calm', 'pressured', 'bored', 'relaxed'] },
    { scenario: 'You made someone smile when they were sad', emoji: '😊', correct: 'fulfilled', options: ['guilty', 'fulfilled', 'jealous', 'angry'] },
    ...
    { scenario: 'You realize you were wrong about someone', emoji: '🤔', correct: 'humbled', options: ['humbled', 'arrogant', 'bored', 'excited'] },
    { scenario: 'You watch the sunset after a really hard day', emoji: '🌅', correct: 'peaceful', options: ['peaceful', 'frustrated', 'anxious', 'angry'] },
    { scenario: 'You get a heartfelt thank-you note', emoji: '💌', correct: 'touched', options: ['touched', 'indifferent', 'annoyed', 'bored'] },
  ],
  16: [
    { scenario: 'Everyone is depending on you to win', emoji: '🏅', correct: 'pressured', options: ['calm', 'pressured', 'bored', 'relaxed'] },
    { scenario: 'You made someone smile when they were sad', emoji: '😊', correct: 'fulfilled', options: ['guilty', 'fulfilled', 'jealous', 'angry'] },
    ...
    { scenario: 'You watch the sunset after a really hard day', emoji: '🌅', correct: 'peaceful', options: ['peaceful', 'frustrated', 'anxious', 'angry'] },
    { scenario: 'You get a heartfelt thank-you note', emoji: '💌', correct: 'touched', options: ['touched', 'indifferent', 'annoyed', 'bored'] },
    { scenario: 'You stand up for someone being treated unfairly', emoji: '🛡️', correct: 'courageous', options: ['courageous', 'timid', 'indifferent', 'bored'] },
  ],
  17: [
    { scenario: 'Everyone is depending on you to win', emoji: '🏅', correct: 'pressured', options: ['calm', 'pressured', 'bored', 'relaxed'] },
    { scenario: 'You made someone smile when they were sad', emoji: '😊', correct: 'fulfilled', options: ['guilty', 'fulfilled', 'jealous', 'angry'] },
    ...
    { scenario: 'You get a heartfelt thank-you note', emoji: '💌', correct: 'touched', options: ['touched', 'indifferent', 'annoyed', 'bored'] },
    { scenario: 'You stand up for someone being treated unfairly', emoji: '🛡️', correct: 'courageous', options: ['courageous', 'timid', 'indifferent', 'bored'] },
    { scenario: 'You learn your hero has a major flaw', emoji: '💫', correct: 'disillusioned', options: ['disillusioned', 'excited', 'proud', 'bored'] },
  ],
  18: [
    { scenario: 'Everyone is depending on you to win', emoji: '🏅', correct: 'pressured', options: ['calm', 'pressured', 'bored', 'relaxed'] },
    { scenario: 'You made someone smile when they were sad', emoji: '😊', correct: 'fulfilled', options: ['guilty', 'fulfilled', 'jealous', 'angry'] },
    ...
    { scenario: 'You stand up for someone being treated unfairly', emoji: '🛡️', correct: 'courageous', options: ['courageous', 'timid', 'indifferent', 'bored'] },
    { scenario: 'You learn your hero has a major flaw', emoji: '💫', correct: 'disillusioned', options: ['disillusioned', 'excited', 'proud', 'bored'] },
    { scenario: 'You finally understand a concept that confused you', emoji: '💡', correct: 'enlightened', options: ['enlightened', 'confused', 'bored', 'angry'] },
  ],
  19: [
    { scenario: 'Everyone is depending on you to win', emoji: '🏅', correct: 'pressured', options: ['calm', 'pressured', 'bored', 'relaxed'] },
    { scenario: 'You made someone smile when they were sad', emoji: '😊', correct: 'fulfilled', options: ['guilty', 'fulfilled', 'jealous', 'angry'] },
    ...
    { scenario: 'You learn your hero has a major flaw', emoji: '💫', correct: 'disillusioned', options: ['disillusioned', 'excited', 'proud', 'bored'] },
    { scenario: 'You finally understand a concept that confused you', emoji: '💡', correct: 'enlightened', options: ['enlightened', 'confused', 'bored', 'angry'] },
    { scenario: 'You hear your favorite song after years apart', emoji: '🎵', correct: 'nostalgic', options: ['nostalgic', 'bored', 'angry', 'indifferent'] },
  ],
  20: [
    { scenario: 'Everyone is depending on you to win', emoji: '🏅', correct: 'pressured', options: ['calm', 'pressured', 'bored', 'relaxed'] },
    { scenario: 'You made someone smile when they were sad', emoji: '😊', correct: 'fulfilled', options: ['guilty', 'fulfilled', 'jealous', 'angry'] },
    ...
    { scenario: 'You finally understand a concept that confused you', emoji: '💡', correct: 'enlightened', options: ['enlightened', 'confused', 'bored', 'angry'] },
    { scenario: 'You hear your favorite song after years apart', emoji: '🎵', correct: 'nostalgic', options: ['nostalgic', 'bored', 'angry', 'indifferent'] },
    { scenario: 'You realize how far you have come in life', emoji: '🌱', correct: 'reflective', options: ['reflective', 'bored', 'angry', 'indifferent'] },
  ],
};
